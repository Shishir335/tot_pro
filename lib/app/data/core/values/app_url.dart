...
class ApiURL {
  ...
  static const String addressUpdateByIdUrl = '${baseApiUrl}additional-addresses/1';
  ...
  static const String getCompleteWorkDetailsUrl = '${baseApiUrl}completed-work/';
  ...
  static const String accountDeleteThenLogoutUrl = '${baseApiUrl}check-available-user/'; // id

  ///------------- Request call -----------------------
  static const String requestCallUrl = '${baseApiUrl}call-back';
  /// account delete request
  static const String accountDeleteReqUrl = '${baseApiUrl}account-delete-request';
